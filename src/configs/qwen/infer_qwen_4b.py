...
from configs.qwen.train_qwen import func_load_decoder, func_load_encoder
...
cfg.exp_code = "qwen3_4b-srgt_ft-enc"
cfg.eval_batch_size = 1

cfg.eval_ckpt_path = [
    osp.join(
        cfg.ckpt_root,
        "qwen3_4b-srgt_ft-enc",
        "ckpt_01_0004879.pth",
    ),
]
...
cfg.eval_enable_vllm = bool(1)
cfg.eval_vllm_tensor_parallel_size = 1
cfg.eval_vllm_gpu_memory_utilization = 0.8
...
def func_load_gen_cls():
    from models.generator_qwen import Qwen3EvalLM, Qwen3EvalVLM

    return Qwen3EvalLM if EVAL_LANGUAGE_MODEL else Qwen3EvalVLM
