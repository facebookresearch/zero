...
cfg.exp_code = (
    f"lang_{cfg.decoder}{cfg.llama_model_version}_{cfg.llama_model_scale}b-{is_surrogate}"
    f"_{training_stage}"
)
...
def func_load_encoder():
    def load_empty_encoder(cfg: object, **kwargs: dict):
        """
        empty fun for language-only training
        """
        return None, None, None

    return load_empty_encoder
